            ...
            <div class="modal fade" id="myModal">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="agregaDetalle.htm" method="post">                   

                            <input  id="prodId_0" name="prodId0"  type="hidden" value="0">
                            <input  id="valor_0"  name="valor0"  type="hidden"  value="0">
                            <input  id="prodNom0" name="prodNom0"  type="hidden" value="">
                            <input  id="pordStock0"  name="pordStock0"  type="hidden"  value="0">

                            <input  id="prodId_1" name="prodId1" type="hidden"  value="0">
                            <input  id="valor_1" name="valor1"  type="hidden"  value="0">            
                            <input  id="prodNom1" name="prodNom1"  type="hidden" value="">
                            <input  id="pordStock1"  name="pordStock1"  type="hidden"  value="0">

                            <input  id="prodId_2" name="prodId2" type="hidden"  value="0">
                            <input  id="valor_2" name="valor2"  type="hidden"  value="0">                
                            <input  id="prodNom2" name="prodNom2"  type="hidden" value="">
                            <input  id="pordStock2"  name="pordStock2"  type="hidden"  value="0">

                            <!--Hidden para identificar el tipo de cliente -->
                            <input  id="tipoCliente" name="tipoCli"  type="hidden" value="${tipo.tipoCli}">
                            <input  id="idCliente" name="idCliente"  type="hidden" value="${tipo.idCliente}">
                            <!-- Modal footer   data-dismiss="modal"   -->                        
                            <div class="modal-footer">
                                <button class="btn btn-danger float-right">Comprar</button>
        ...
        <div class="row">             
            <div class="col-lg-12">
                <footer class="text-center">
                    ...
                    <input  id="totalDetalle" name="totalDetalle"  type="hidden" value="0">
                </footer>
            </div>
        </div>
    </body>
